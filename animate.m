function animate(T, dt, X, U, PWM, len, start)

fastforward=50;
record=false;
Frames=draw_3d_animation(T, X, U, PWM, dt, len, record, false, fastforward, 98, 30, start);
...
%                              axis limit                                %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
xyz_min = min(X_data(:,1:3))-2*len; xyz_max=max(X_data(:,1:3))+2*len;
